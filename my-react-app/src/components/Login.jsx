...
class Login extends Component {
  ...
  handleEmailLogin = () => {
    ...
    this.handleResponse('https://tunimarket.vercel.app/auth/login', { email, password }, this.props.onLoginSuccess);
  };
  ...
  handleGoogleLogin = async () => {
    try {
      ...
      this.handleResponse('https://tunimarket.vercel.app/auth/google', { idToken }, this.props.onLoginSuccess);
    } catch (error) {
  ...
  handleRegister = () => {
    const { email, password } = this.state;
    this.handleResponse('https://tunimarket.vercel.app/auth/register', { email, password }, this.handleEmailLogin);
  };
