...
class Login extends Component {
  ...
  handleEmailLogin = () => {
    ...
    this.handleResponse('https://tunimarket.onrender.com/auth/login', { email, password }, this.props.onLoginSuccess);
  };
  ...
  handleGoogleLogin = async () => {
    try {
      ...
      this.handleResponse('https://tunimarket.onrender.com/auth/google', { idToken }, this.props.onLoginSuccess);
    } catch (error) {
  ...
  handleRegister = () => {
    const { email, password } = this.state;
    this.handleResponse('https://tunimarket.onrender.com/auth/register', { email, password }, this.handleEmailLogin);
  };
